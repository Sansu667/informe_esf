...
<<importar_datos, echo=FALSE>>=
player_statistics_cleaned_final <- read_csv("C:/Users/Lenovo/OneDrive/Documentos/informe1/player_statistics_cleaned_final.csv")
@

<<cambiar_tipos, echo=FALSE>>=
player_statistics_cleaned_final$TeamName <- as.factor(player_statistics_cleaned_final$TeamName)
player_statistics_cleaned_final$PlayerName <- as.factor(player_statistics_cleaned_final$PlayerName)
player_statistics_cleaned_final$Position <- as.factor(player_statistics_cleaned_final$Position)
player_statistics_cleaned_final$`Solo Kills` <- as.factor(player_statistics_cleaned_final$`Solo Kills`)
player_statistics_cleaned_final$Country <- as.factor(player_statistics_cleaned_final$Country)
player_statistics_cleaned_final$FlashKeybind <- as.factor(player_statistics_cleaned_final$FlashKeybind)
@
...
\section{Análisis descriptivo}
  ...
  \begin{enumerate}
    ...
    \item \textit{Gold Per Min},
    \item \textit{Damage Percent},
    \item \textit{Country}
  \end{enumerate}
